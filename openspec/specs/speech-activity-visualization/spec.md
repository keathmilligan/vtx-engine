...
TBD — Specification for the speech activity visualization draw path and grid labeling in the vtx-viz package, covering how metric data is rendered from the history buffer.
